...
public class ChitChatSharedPref {

    private final SharedPreferences mSharedPreferences;
    private static ChitChatSharedPref mInstance;
    private static String PREF_NAME;


    private ChitChatSharedPref(Context context) {
    ...
    public static synchronized void initializeInstance(Context context) {
        if (mInstance == null) {
            mInstance = new ChitChatSharedPref(context);
        }
    }

    public static synchronized ChitChatSharedPref getInstance() {
        if (mInstance == null) {
            throw new IllegalStateException(ChitChatSharedPref.class.getSimpleName() +
