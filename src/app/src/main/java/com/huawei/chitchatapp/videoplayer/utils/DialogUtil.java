...
import com.huawei.chitchatapp.videoplayer.contract.OnDialogConfirmListener;
import com.huawei.chitchatapp.videoplayer.contract.OnDialogInputValueListener;
import com.huawei.chitchatapp.videoplayer.contract.OnHomePageListener;
import com.huawei.chitchatapp.videoplayer.contract.OnPlaySettingListener;
import com.huawei.chitchatapp.videoplayer.view.PlaySettingDialog;
...
public class DialogUtil {
    ...
    public static void initPreloaderDialog(final Context context,
        ...
        okBt.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Preloader preloader = ChitChatApplication.getWisePlayerFactory().createPreloader();
